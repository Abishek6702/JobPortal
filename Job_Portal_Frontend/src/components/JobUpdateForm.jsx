...
export default function JobUpdateForm({ job, onClose }) {
  ...
  return (
    <div className=" joblist_model_bg fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-[100%] z-10">
      <div className=" w-[100%]  lg:w-[60%] relative top-20 m-auto p-6 border shadow-lg rounded-md bg-white">
          ...
          <div className="flex flex-col space-y-4 w-[80%] m-auto">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("whereYouWillDoIt", e.target.value)
                }
              />
            </div>
          ...
          <div className="flex flex-col space-y-6 w-full max-w-2xl mx-auto px-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("tools", e.target.value.split(","))
                }
              />
            </div>
          </div>
        ...
        {step === 3 && (
          <div className="flex flex-col space-y-6 w-full max-w-2xl mx-auto px-4">
            <div>
              ...
              <input
                className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Additional Benefits (comma separated)"
          ...
          <div className="flex flex-col space-y-6 w-full max-w-2xl mx-auto px-4">
            <div>
              ...
              <input
                className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Founded"
                value={formData.companyOverview.founded}
                onChange={(e) =>
                  handleChange("companyOverview", {
            ...
            <div>
              <label className="block text-lg font-semibold mb-1">Sector</label>
              <input
                className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Sector"
            ...
            <div>
              <label className="block text-lg font-semibold mb-1">Size</label>
              <input
                className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Size"
