    ...
    const token = jwt.sign(
      {
        ...
        appliedjobs: user.appliedJobs || [], // This contains only the job IDs (ObjectIds)
      },
...
exports.getUserById = async (req, res) => {
  try {
    ...
    const user = await User.findById(req.params.id).populate("savedJobs"); // populate saved jobs
